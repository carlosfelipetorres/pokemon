 ...
 *
 * @author <a href="mailto:carlosfelipetorres75@gmail.com">Carlos Felipe Torres</a>
 */
public class DatabaseHelper extends OrmLiteSqliteOpenHelper {
    ...
    private void onCreate() {
        try {
            ...
            TableUtils.createTable(connectionSource, PokemonItem.class);
            TableUtils.createTable(connectionSource, PokemonInfo.class);
    ...
    private void onUpgrade(int oldVersion, int newVersion) {
        try {
            ...
            TableUtils.dropTable(connectionSource, PokemonItem.class, true);
            TableUtils.dropTable(connectionSource, PokemonInfo.class, true);
