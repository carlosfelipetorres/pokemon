 ...
 */
public class ClientePokemonSystem implements IClientePokemonSystem {

    /**
     * Tag for logs
     **/
    private static final String TAG_LOG = ClientePokemonSystem.class.getName();
    ...
    public <T> T getApi(Class<T> clazz) {
        ...
        synchronized (ClientePokemonSystem.class) {
            if (mRetrofit == null) {
